...
//            @RequestPart("applicationDTO") String applicationDTOString,  // Accept DTO as JSON string
//            @RequestPart("file") MultipartFile file) {
//        try {
//            ApplicationDTO applicationDTO = objectMapper.readValue(applicationDTOString, ApplicationDTO.class);
//            applicationDTO.setResume(file);
